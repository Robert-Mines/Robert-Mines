...
/**
 * ********************************************************
 * Program Name: DataIO.java Programmer's Name: Robert Mines Program
 * Description: Border class to handle data processing
 * *********************************************************
 */
/**
 *
...
public class DataIO {
    ...
    // Behaviors
    public void add(Customer cust) throws IOException, SQLException, ClassNotFoundException {
        //check for driver
